...
imgHenry = cv2.cvtColor(imgHenry, cv2.COLOR_BGR2RGB)
...
cv2.rectangle(imgHenry, (faceLoc[3], faceLoc[0]), (faceLoc[1], faceLoc[2]), (255, 0, 255), 2)
...
cv2.imshow('Henry', imgHenry)
cv2.imshow('Henry Test', imgTest)
cv2.waitKey(0)
